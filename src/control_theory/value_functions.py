...
class ValueFunction:
    ...
    def gradient(self, state: Union[State, jnp.ndarray], time: Optional[float] = None) -> jnp.ndarray:
    ...
    def hessian(self, state: Union[State, jnp.ndarray], time: Optional[float] = None) -> jnp.ndarray:
...
class ValueFunctionSolver(ABC):
    ...
    def verify_solution(self, value_function: ValueFunction, 
